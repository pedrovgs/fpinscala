[![Build status](https://travis-ci.org/pedrovgs/fpinscala.svg?branch=master)](https://travis-ci.org/pedrovgs/fpinscala) [![Join the chat at https://gitter.im/fpinscala/fpinscala](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/fpinscala/fpinscala?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)

**This repository is a fork of the original [fpinscala repository](https://github.com/fpinscala/fpinscala) with the exercises resolved by me.**
